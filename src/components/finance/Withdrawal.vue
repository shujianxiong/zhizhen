...
<template>
    <div class="withdrawal">
        <el-menu :default-active="activeIndex2" class="el-menu-demo" mode="horizontal" @select="handleSelect"
            ...
            <el-menu-item index="1">提现管理</el-menu-item>
        </el-menu>
        ...
        <div class="drawalmain">
            <div class="drawalfind">
                <el-form :inline="true" :model="formInline" class="demo-form-inline" size="small"
                    ...
                    <el-form-item>
                        <el-input v-model="formInline.no" placeholder="请输入提现编号"></el-input>
                    </el-form-item>
                    <el-form-item>
                        <el-input v-model="formInline.nick" placeholder="请输入提现人昵称"></el-input>
                    </el-form-item>
                    <el-form-item>
                        <el-input v-model="formInline.phone" placeholder="请输入提现人手机号"></el-input>
                    </el-form-item>
                    <el-form-item>
                        <el-select v-model="formInline.type" clearable placeholder="请选择提现方式" @change='getapplyType'>
                            <el-option label="微信" value="2"></el-option>
                            <el-option label="支付宝" value="1"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item>
                        <el-input v-model="formInline.number" placeholder="请输入提现账号"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item>
                        <el-select v-model="formInline.state" clearable placeholder="请选择提现状态" @change='getapplyStatus'>
                            <el-option label="提现成功" value="1"></el-option>
                            <el-option label="提现状态" value="2"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item>
            ...
            <div class="drawaldata">
                ...
                <el-table ref="multipleTable" border :data="withData" tooltip-effect="dark"
                    ...
                    <el-table-column prop="nickName" label="提现人昵称"> </el-table-column>
                    <el-table-column prop="phone" label="提现人手机号"> </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getFinanceApply() {
                this.$api.post({
                    ...
                    params: {
                        ...
                        applyStatus: this.formInline.state,
                        pageNum: this.formInline.pageNum,
                        pageSize: this.formInline.pageSize
                    }, success: (data) => {
                        console.log(data)
            ...
            getexport() {
                ...
                // params.is_export = 1
                this.$download('http://manager.zhizhennengyuan.com:8000/manage/export', params, '提现管理').then(res => {
